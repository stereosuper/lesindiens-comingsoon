<template>
    <footer class="container">
        <div>
            <a target="_blank" rel="noopener nofollower" href="https://www.instagram.com/studio_lesindiens/">
                Instagram
            </a>
...
@media (min-width: $desktop-xxl) {
    footer {
        ...
        right: calc(((100% - 180px) * 3 / 12) + 90px);
    }
}
</style>
